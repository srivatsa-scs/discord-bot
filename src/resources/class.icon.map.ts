...
classMap.set('21', { color: '#A62019', url: 'https://wiki.guildwars2.com/images/c/c7/Herald_tango_icon_200px.png' });
classMap.set('22', { color: '#A62019', url: 'https://wiki.guildwars2.com/images/b/bc/Renegade_tango_icon_200px.png' });

classMap.set('30', { color: '#969C9F', url: 'https://wiki.guildwars2.com/images/1/19/Thief_tango_icon_200px.png' });
classMap.set('31', { color: '#969C9F', url: 'https://wiki.guildwars2.com/images/c/ca/Daredevil_tango_icon_200px.png' });
classMap.set('32', { color: '#969C9F', url: 'https://wiki.guildwars2.com/images/b/b0/Deadeye_tango_icon_200px.png' });

classMap.set('40', { color: '#008E44', url: 'https://wiki.guildwars2.com/images/5/51/Ranger_tango_icon_200px.png' });
classMap.set('41', { color: '#008E44', url: 'https://wiki.guildwars2.com/images/6/6d/Druid_tango_icon_200px.png' });
classMap.set('42', { color: '#008E44', url: 'https://wiki.guildwars2.com/images/f/f6/Soulbeast_tango_icon_200px.png' });

classMap.set('50', { color: '#F93A2F', url: 'https://wiki.guildwars2.com/images/2/2f/Engineer_tango_icon_200px.png' });
...
classMap.set('90', { color: '#FFFFFF', url: 'https://wiki.guildwars2.com/images/e/eb/Any_tango_icon_200px.png' });
